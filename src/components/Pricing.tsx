...
function PricingCard({ title }: PricingCardProps) {
  return (
    <div className="w-[300px] text-center rounded p-10">
      ...
      <p className="text-[#747474]">per user, per month</p>
      ...
      <div className="flex flex-col gap-3 mt-5">
        <p className="text-[#747474]">5 Social Profiles</p>
        <p className="text-[#747474]">5 Scheduled Posts Per Profile</p>
        <p className="text-[#747474]">400+ Templates</p>
        <p className="text-[#747474]">Calendar View</p>
        <p className="text-[#747474]">24/7 Support</p>
      </div>
    </div>
  );
}
  ...
  return (
    <section className="flex mt-[78px] justify-between">
      ...
      <div className="text-center rounded bg-[#2C3140] w-[300px] text-white p-10">
        ...
        <p className="text-[#DDD]">per user, per month</p>
        <button className="rounded-[3px] h-[52px] w-[223px] font-semibold border-solid border-2 bg-[#1465FA] text-white mt-[23px]">
          Start My 15-day trial
        </button>
        <div className="flex flex-col gap-3 mt-5">
          <p className="text-[#DDD]">5 Social Profiles</p>
          <p className="text-[#DDD]">5 Scheduled Posts Per Profile</p>
          <p className="text-[#DDD]">400+ Templates</p>
          <p className="text-[#DDD]">Calendar View</p>
